...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`container transition-200 ${
          isVisible ? "opacity-0" : "opacity-100"
        } items-center flex justify-between mx-auto p-6`}
      >
        <img src="images/logo-bookmark.svg" alt="Logo" />

        <nav className="md:flex hidden gap-12 items-center ">
          <ul>
            <li>
              <a
      ...
      <div
        className={`fixed  z-10 md:hidden duration-500 ${
          isVisible ? "left-0" : "left-[1000px]"
        } flex flex-col justify-between bg-[#252b46]/90  w-full h-full p-9 top-0`}
      >
        <div className="flex flex-col gap-10">
          <div className="flex justify-between items-center">
            ...
            <button onClick={hideMenu} aria-label="click to close the menu">
          ...
          <nav className="flex flex-col text-center">
            <ul>
              <li className="p-6 border-b">
                <a
                  className=" tracking-widest text-xl font-medium uppercase text-white"
                  href="#Features"
                >
                  Features
                </a>
            ...
            <button className="p-3 mt-6 border-2 rounded tracking-widest text-xl font-medium uppercase text-white">
              login
            </button>
          </nav>
        </div>
