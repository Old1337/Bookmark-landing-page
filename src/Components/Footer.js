...
const Footer = () => {
  return (
    <footer className="bg-heading">
      <div className="flex container mx-auto flex-col md:flex-row md:justify-between gap-10 py-7">
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-20">
          ...
          <div className="flex flex-col md:flex-row text-center gap-5 md:gap-20 text-gray-300">
            <a
              className="duration-200 tracking-widest hover:text-red-400"
              href="#features"
            >
              Features
            </a>
        ...
        <div className="flex justify-center gap-10">
          <img
            className="hover:hue-rotate-[130deg] cursor-pointer"
            src="images/icon-facebook.svg"
            alt=""
          />
          <img
            className="hover:hue-rotate-30 cursor-pointer"
